...
def main():
    ...
    parser.add_argument('--showStream', action='store_true', default=False, help="if you want to see it work.q")
    ...
    while ACTIVE:
        ...
        if model.object_detected:
            ...
            h, v, angle = Utils.auto_target((location))
            Utils.move(h, v, angle, control, 3) #as of now does not take distance into account
            time.sleep(1)
